...
const CheckoutPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const orderId = orderRes.data._id; // ✅ Capture Order ID
      sessionStorage.setItem('orderId', orderId); // ✅ SAVE it in sessionStorage
      ...
      if (result.error) {
        ...
        clearCart();
        navigate('/payment-success'); // ✅ Navigate to PaymentSuccess page after success
      }
    } catch (error) {
      if (error.response) {
